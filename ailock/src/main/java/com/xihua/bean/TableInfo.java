...
public class TableInfo  extends BaseEntity {
     ...
     * 表描述
     */
    private String tableSelectText;
    private String packageName;
    private String moduleName;
    private String author;


    public String getTableSelectText() {
        return this.getTableName() + "-" + this.getTableComment();
    }

    public void setTableSelectText(String tableSelectText) {
        this.tableSelectText = tableSelectText;
    }
    ...
    public String toString() {
        return "TableInfo{" +
                ...
                ", className='" + className + '\'' +
                ", classname='" + classname + '\'' +
                ", tableSelectText='" + tableSelectText + '\'' +
