...
public class NIOServerCnxnFactory extends ServerCnxnFactory implements Runnable {
    ...
    @Override
    public void startup(LockServer lockServer) throws IOException, InterruptedException {
    ...
    protected NIOServerCnxn createConnection(SocketChannel sock, SelectionKey sk) throws IOException {
        return new NIOServerCnxn(lockServer, sock, sk, this);
    }
    ...
    public synchronized void closeAll() {
        ...
        for (NIOServerCnxn cnxn : cnxns) {
            try {
                ...
                LOG.warn("Ignoring exception closing serverCnxn", e);
            }
        }
    }
